...
const GET_NAMES_URL = (species: SPECIES, gender?: string) =>
  `${BASE_URL}/${NPC_PATH}/${NAMES_PATH}/${species}?gender=${gender}`
...
// NAVIGATION
const NAV_CREATE_SHOP_URL = 'create-shop' as const
const NAV_MY_SHOPS_URL = 'my-shops' as const
const NAV_NPC_URL = 'npc' as const
